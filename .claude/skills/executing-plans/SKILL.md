...
## TEAM PLAN GUARD - CHECK FIRST

**Before anything else, check if this is a team-orchestrated plan:**

```
┌─────────────────────────────────────────────────────────────┐
│  Does the plan contain ANY of these?                        │
│                                                             │
│  □ ## Team Orchestration                                    │
│  □ EXECUTION DIRECTIVE (blockquote at top)                  │
│  □ ## Team Members (with Builder/Agent Type entries)        │
│  □ References to TeamCreate, Task agents, or /build         │
│                                                             │
│  If YES to ANY → STOP. Do NOT use this skill.              │
│  Instead: invoke /build specs/<plan-file>.md                │
│                                                             │
│  This skill is for SOLO plan execution only.                │
│  Team plans MUST go through /build which orchestrates       │
│  agents — direct implementation is FORBIDDEN.               │
└─────────────────────────────────────────────────────────────┘
```
