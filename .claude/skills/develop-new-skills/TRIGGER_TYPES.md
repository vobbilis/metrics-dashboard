...
Complete reference for configuring skill triggers in the skill auto-activation system.
...
echo '{"session_id":"test","prompt":"your test prompt"}' | \
  npx tsx .github/hooks/skill-activation-prompt.ts
```

**Test file path/content triggers:**
```bash
cat <<'EOF' | npx tsx .github/hooks/skill-verification-guard.ts
{
  "session_id": "test",
  "tool_name": "Edit",
