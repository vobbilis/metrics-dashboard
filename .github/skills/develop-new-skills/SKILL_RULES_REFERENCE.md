...
Complete schema and configuration reference for `.github/skills/skill-rules.json`.
...
**Path:** `.github/skills/skill-rules.json`
...
```bash
cat .github/skills/skill-rules.json | jq .
```
